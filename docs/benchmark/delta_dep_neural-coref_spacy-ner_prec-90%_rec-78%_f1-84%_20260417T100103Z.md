# Delta Dependency Benchmark — 20260417T100103Z
...
|-----------|----|----|----|-----------+--------|-----|
| connective | 8 | 0 | 1 | 100.0% | 88.9% | 94.1% |
| entity_overlap | 4 | 1 | 1 | 80.0% | 80.0% | 80.0% |
| chain | 5 | 0 | 0 | 100.0% | 100.0% | 100.0% |
| coreference | 1 | 1 | 3 | 50.0% | 25.0% | 33.3% |

## Per-case results

| # | Mechanism | Description | Expected edges | TP | FP | FN | Result |
|---|-----------|-------------|----------------|----|----|-----|--------|
| 1 | connective | causal: therefore links vendor-fail → contract-terminated | 1 | 1 | 0 | 0 | ✓ |
...
| 12 | entity_overlap | overlap: same subject (board) in two facts | 1 | 0 | 0 | 1 | ~ FN |
...
- **overlap: same subject (board) in two facts**: 1 edge(s) missed — edge missing: 'The board approve' → 'The board approve'
...
- **coref: she → manager**: 1 edge(s) missed — edge missing: 'The manager approve' → 'manager notify'
