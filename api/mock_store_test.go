...
func (m *MockStore) GetSessionHistoryAfter(sessionID string, afterTimestamp int64) ([]store.JournalEntry, error) {
	if m.GetSessionHistoryAfterFunc != nil {
		return m.GetSessionHistoryAfterFunc(sessionID, afterTimestamp)
	}
	return nil, nil
}
func (m *MockStore) GetSessionHistoryBefore(sessionID string, beforeTimestamp int64) ([]store.JournalEntry, error) {
	if m.GetSessionHistoryBeforeFunc != nil {
		return m.GetSessionHistoryBeforeFunc(sessionID, beforeTimestamp)
	}
	return nil, nil
}
func (m *MockStore) GetSessionHistoryChainHead(sessionID string) (string, error) {
	if m.GetSessionHistoryChainHeadFunc != nil {
		return m.GetSessionHistoryChainHeadFunc(sessionID)
	}
	return "", nil
}
...
func (m *MockStore) SaveOrganization(org *store.Organization) error {
	if m.SaveOrganizationFunc != nil {
		return m.SaveOrganizationFunc(org)
	}
	return nil
}
func (m *MockStore) UpsertOrgSessionIndex(orgID, sessionID string, createdAt int64) error {
	if m.UpsertOrgSessionIndexFunc != nil {
		return m.UpsertOrgSessionIndexFunc(orgID, sessionID, createdAt)
	}
	return nil
}
func (m *MockStore) TouchOrgSession(orgID, sessionID string, factDelta int) error {
	if m.TouchOrgSessionFunc != nil {
		return m.TouchOrgSessionFunc(orgID, sessionID, factDelta)
	}
	return nil
}
func (m *MockStore) GetOrgUsage(orgID string) (map[string]uint64, error) {
	if m.GetOrgUsageFunc != nil {
		return m.GetOrgUsageFunc(orgID)
	}
	return nil, nil
}
...
func (m *MockStore) GetAPIKeyOwner(key string) ([]byte, error) {
	if m.GetAPIKeyOwnerFunc != nil {
		return m.GetAPIKeyOwnerFunc(key)
	}
	return nil, nil
}
func (m *MockStore) GetAPIKeyOwnerByHash(keyHash string) ([]byte, error) {
	if m.GetAPIKeyOwnerByHashFunc != nil {
		return m.GetAPIKeyOwnerByHashFunc(keyHash)
	}
	return nil, nil
}
func (m *MockStore) SaveAPIKeyHash(keyHash, email string) error {
	if m.SaveAPIKeyHashFunc != nil {
		return m.SaveAPIKeyHashFunc(keyHash, email)
	}
	return nil
}
func (m *MockStore) DeleteAPIKeyHash(keyHash string) error {
	if m.DeleteAPIKeyHashFunc != nil {
		return m.DeleteAPIKeyHashFunc(keyHash)
	}
	return nil
}
...
func (m *MockStore) GetIdempotency(orgID string, keyHash string, maxAge time.Duration) (*store.IdempotencyRecord, error) {
	if m.GetIdempotencyFunc != nil {
		return m.GetIdempotencyFunc(orgID, keyHash, maxAge)
	}
	return nil, nil
}
